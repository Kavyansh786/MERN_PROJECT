  ...
  return (
    <div className="min-h-screen bg-[#fdf8f6]">
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-8 pt-10 pb-2">
        ...
        <p className="text-lg md:text-xl text-[#8D6E63] mb-6 text-left max-w-2xl">Discover our stunning collection of bracelets — from elegant bangles to statement cuffs. Each piece is crafted with precision and care.</p>
      </section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 justify-items-center">
            {filteredProducts.length === 0 ? (
              <div className="col-span-full text-center py-12">
                ...
                <p className="text-gray-500 text-lg mb-2">No bracelets found</p>
